  ...
  return (
   ...
   <div>
    <div className="text text-center p-2">
        <h5>FREE SHIPPING ON ALL ORDERS   |   USE CODE: SHIP</h5>
    </div>
    <div className="container-fluid p-0">
      <div
        ...
        data-bs-wrap="true"      /* Loop back to first slide */
      >
        <div className="carousel-inner">
          ...
          <div className="carousel-item">
           <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTeAmAynx-wgUqrKzgXtmkR3sPs5IM-QMosuQ&s"
              className="d-block w-100"
              alt="Slide 2"
            />
            <div className="carousel-caption d-none d-md-block">
